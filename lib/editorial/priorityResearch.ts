...
const profiles: Record<string, PriorityResearchProfile> = {
  ...
  '/blog/quebec-small-business-grants-guide': {
    ...
    seoTitle: 'Quebec Small Business Grants 2026: Programs & Eligibility',
    seoDescription: 'Find Quebec small-business grants, tax credits, and financing. Compare eligibility, program types, and application steps using official sources.',
    expectedIntent: 'medium',
    reviewedBy: REVIEWED_BY,
    reviewerRole: REVIEWER_ROLE,
    ...
    shortAnswerQuestion: 'What grants and funding are available to Quebec small businesses in 2026?',
    shortAnswer: 'Quebec small businesses can evaluate federal regional-development contributions, provincial tax credits, and financing from provincial or regional partners. The right route depends on project location, eligible costs, innovation, and economic impact. Confirm whether support is repayable and whether approval is required before spending.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve Quebec funding match',
      title: 'See which Quebec funding routes fit your business',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=quebec-small-business-grants-guide&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    faq: [
      {
  ...
  '/blog/nih-sbir-biotech-grants': {
    ...
    shortAnswerQuestion: 'Who qualifies for NIH SBIR grants in 2026, and how do startups apply?',
    shortAnswer: 'NIH SBIR/STTR supports eligible U.S. small businesses conducting health-related R&D. Start by confirming ownership and size eligibility, matching the project to a participating NIH institute and active notice, and completing the required registrations. The selected opportunity controls its dates, budget, review criteria, and application requirements.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve NIH funding match',
      title: 'See which NIH and health-funding routes fit your R&D',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=nih-sbir-biotech-grants&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    faq: [
      {
  ...
  '/blog/nsf-sbir-grants-technology-startups': {
    ...
    shortAnswerQuestion: 'Who qualifies for NSF SBIR grants in 2026, and what is the Project Pitch?',
    shortAnswer: 'NSF SBIR/STTR is intended for eligible U.S. small businesses pursuing high-risk R&D around a differentiated technology with commercial potential. The required first step is a Project Pitch explaining the innovation, technical risk, market opportunity, and team. Only invited companies proceed to a full proposal.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve NSF funding match',
      title: 'See which NSF and technology-funding routes fit your R&D',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=nsf-sbir-grants-technology-startups&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    faq: [
      {
  ...
  '/usa/technology-startup-grants': {
    ...
    seoTitle: 'Technology Startup Grants 2026: U.S. SBIR/STTR Guide',
    seoDescription: 'Compare U.S. SBIR/STTR funding routes for technology startups. Find the right federal agency by mission, solicitation, R&D risk, and commercialization fit.',
    expectedIntent: 'high',
    reviewedBy: REVIEWED_BY,
    reviewerRole: REVIEWER_ROLE,
    lastVerified: '2026-07-12',
    ...
    shortAnswerQuestion: 'What grants are available to U.S. technology startups in 2026?',
    shortAnswer: 'U.S. technology startups can evaluate SBIR/STTR funding across participating federal agencies. Choose the route by agency mission, active solicitation, technical risk, company eligibility, and commercialization path. Each agency manages its own topics, review process, and awards.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve technology funding match',
      title: 'See which U.S. technology-funding routes fit your startup',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=grant-guide&context=technology-startup-grants&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    relatedPath: {
  ...
  '/blog/nasa-sbir-space-tech-grants': {
    ...
    seoTitle: 'NASA SBIR Grants 2026: Eligibility, Phases & Topics',
    seoDescription: 'Learn how NASA SBIR/STTR works for space and aerospace startups. Check eligibility, current solicitation topics, Phase I/II rules, and application steps.',
    expectedIntent: 'high',
    reviewedBy: REVIEWED_BY,
    reviewerRole: REVIEWER_ROLE,
    lastVerified: '2026-07-12',
    ...
    shortAnswerQuestion: 'Who qualifies for NASA SBIR grants in 2026, and how do startups apply?',
    shortAnswer: 'NASA SBIR/STTR supports eligible U.S. small businesses developing technology that addresses a specific NASA need. Start with the current solicitation, select the closest subtopic, confirm company and project eligibility, and follow that opportunity’s Phase I or Phase II instructions, registrations, dates, and budget rules.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve NASA funding match',
      title: 'See which NASA and space-technology routes fit your R&D',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=nasa-sbir-space-tech-grants&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    relatedPath: {
  ...
  '/blog/dod-sbir-defense-tech-grants': {
    ...
    shortAnswerQuestion: 'Who qualifies for DoD SBIR grants in 2026, and how do startups apply?',
    shortAnswer: 'DoD SBIR/STTR supports eligible U.S. small businesses developing technology for a defined defense-component need. Start with an active topic, confirm company eligibility and dual-use fit, complete the required registrations, and follow the component-specific instructions. The selected opportunity controls its dates, scope, and award limits.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve defense funding match',
      title: 'See which DoD and dual-use funding routes fit your R&D',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=dod-sbir-defense-tech-grants&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
  },
  ...
  '/blog/colorado-tech-programs': {
    ...
    shortAnswerQuestion: 'What Colorado technology startup grants are available in 2026?',
    shortAnswer: 'Colorado technology startups should begin with the Advanced Industries programs and confirm whether their sector, project stage, location, and matching resources meet the current requirements. Federal SBIR/STTR opportunities and applicable state incentives can then be evaluated as separate or complementary funding routes.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve Colorado funding match',
      title: 'See which Colorado technology-funding routes fit your startup',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=colorado-tech-programs&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    relatedPath: {
  ...
  '/blog/usda-sbir-agtech-grants': {
    ...
    shortAnswerQuestion: 'Who qualifies for USDA SBIR grants in 2026, and how do AgTech startups apply?',
    shortAnswer: 'USDA SBIR/STTR supports eligible U.S. small businesses conducting R&D in agricultural technology, food systems, forestry, and related USDA topic areas. Start with the current solicitation, confirm topic and company fit, complete federal registrations, and follow the selected opportunity’s Phase I or Phase II requirements.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve AgTech funding match',
      title: 'See which USDA and AgTech funding routes fit your R&D',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=usda-sbir-agtech-grants&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
  },
  '/usa/kentucky': {
  ...
  '/blog/women-entrepreneurship-strategy-canada': {
    ...
    shortAnswerQuestion: 'What funding is available to women entrepreneurs in Canada in 2026?',
    shortAnswer: 'Women-owned businesses in Canada can evaluate Women Entrepreneurship Strategy lending partners, ecosystem organizations, federal and provincial programs, and commercial financing routes. Eligibility and application channels vary, and some WES funding supports delivery organizations rather than providing direct business grants.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve women-founder funding match',
      title: 'See which Canadian funding routes fit your business',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=women-entrepreneurship-strategy-canada&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    relatedPath: {
  ...
  '/blog/healthcare-grants-2026': {
    ...
    shortAnswerQuestion: 'What government funding supports Canadian health-tech companies in 2026?',
    shortAnswer: 'Canadian health-tech companies can evaluate NRC IRAP for eligible technical R&D, CIHR-linked research opportunities, and SR&ED tax incentives for qualifying experimental development. The right route depends on the applicant, project stage, research partnership, eligible costs, and regulatory pathway.',
    verificationNotes: [
    ...
    cta: {
      eyebrow: 'Self-serve healthcare funding match',
      title: 'See which Canadian health-funding routes fit your project',
      description: 'Get a personalized Funding Match Report with matched programs, requirements, estimated ranges, and priority order. Instant digital delivery—no call required.',
      buttonText: 'Get My $19 Match Report',
      href: '/api/growth-os/onsite-click?surface=blog&context=healthcare-grants-2026&offer=match-report&experiment=focused-v2',
      supportingPoints: ['Matched programs', 'Eligibility requirements', 'Priority application order'],
    },
    relatedPath: {
