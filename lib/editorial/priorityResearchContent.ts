...
const content: Record<string, EditorialSection[]> = {
  '/usa/new-york': [
    ...
    {
      heading: 'True Freshness: Active 2026 New York State Updates',
      summary: 'Empire State Development (ESD) and local economic agencies have updated several key program parameters for the 2026 fiscal year to focus on startup innovation and job creation. Key changes include: 1) NY State SBIR/STTR Matching Fund: Provides up to $100,000 for Phase I winners and up to $250,000 for Phase II winners to accelerate commercialization. 2) Excelsior Jobs Program: Features updated green project tax credits and R&D tax exemptions for tech expansion. 3) NY pre-seed/seed fund: Active capital intakes for early-stage investments through regional partners.',
      bullets: ['Check updated Excelsior Jobs green tax credit rates', 'Apply for NY State SBIR matching funds within 90 days of federal award', 'Confirm regional pre-seed fund active cycles'],
    },
    {
      heading: 'The New York Capital Stacking Playbook (Excelsior + Local Grants)',
      summary: 'To maximize funding runway in New York, smart founders stack state-level tax incentives with local municipal grants. For example, if you expand physical operations in Brooklyn or Queens, you can combine the Excelsior Jobs Program Tax Credits (covering up to 6.85% of new salaries) with the NYC Business Relocation Employment Assistance Program (REAP) to secure up to $3,000 per year per eligible employee. When combined with utility tax credits from the NYC Energy Cost Savings Program (ECSP), you can offset up to 45% of your operational real estate and labor overheads.',
      bullets: ['Stack Excelsior tax credits with municipal REAP incentives', 'Combine NYC energy savings programs to reduce physical facility costs', 'Leverage state R&D tax credits alongside federal research grants'],
    },
    {
      heading: 'Common Application Rejection Mistakes (Why NY Funding is Denied)',
      summary: 'Applicants seeking New York state or city funding are frequently rejected due to baseline compliance and geographical mistakes: 1) Lack of NY Certificate of Authority: Applying for grants or credits without being registered to do business and collect tax in New York State. 2) Location Mismatch: Applying for NYC local microgrants when corporate headquarters are physically registered in Westchester, Nassau, or Upstate counties. 3) Retroactive Project Spending: Registering capital expenditures before Empire State Development has completed official project pre-qualification.',
      bullets: ['Secure your NY State Certificate of Authority before applying', 'Match NYC-specific programs strictly to NYC-metro office addresses', 'Wait for formal project pre-qualification before committing expansion funds'],
    },
    {
      heading: 'Structured Topic Cluster Navigation',
      summary: 'Pass authority to other state-specific and general stacking guides to build topical relevance: Explore U.S. State Grants, New York Business Grants, NYC Metro Grants, and U.S. SBIR Agency Matching guides to construct your complete funding roadmap.',
      bullets: ['Explore U.S. State Grants', 'View NYC Metro Grants Directory', 'Compare U.S. SBIR Matching Programs'],
    },
  ],
  '/usa/california': [
    {
