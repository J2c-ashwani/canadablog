...
const blogPosts = [
  // USA News (8 posts) - IDs 1-8
  {
    ...
    date: "March 15, 2024",
    readTime: "8 min read",
    image: "/images/blog/biden-small-business-grants.jpg",
    featured: true,
  ...
  },
  {
    ...
    image: "/images/blog/sba-sbir-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    image: "/images/blog/usda-rural-development.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "March 22, 2025",
    readTime: "9 min read",
    image: "/images/blog/doe-clean-technology.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    image: "/images/blog/nsf-stem-research.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "May 18, 2025",
    readTime: "10 min read",
    image: "/images/blog/hud-community-development.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "June 1, 2025",
    readTime: "9 min read",
    image: "/images/blog/va-business-grants.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    image: "/images/blog/epa-environmental-justice.jpg",
    featured: true,
  ...
  // Canada News (10 posts) - IDs 9-18  
  {
    ...
    readTime: "11 min read",
    image: "/images/blog/canada-superclusters.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    readTime: "10 min read",
    image: "/images/blog/canada-clean-tech.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "March 8, 2025",
    readTime: "9 min read",
    image: "/images/blog/canada-smb-financing.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "April 12, 2025", 
    readTime: "8 min read",
    image: "/images/blog/canada-agriculture.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "May 6, 2025",
    readTime: "10 min read", 
    image: "/images/blog/indigenous-business-canada.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "June 20, 2025",
    readTime: "9 min read",
    image: "/images/blog/canada-digital-transformation.jpg", 
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "August 15, 2025",
    readTime: "12 min read",
    image: "/images/blog/canada-irap-program.jpg",
    featured: true,
  ...
  },
  {
    ...
    readTime: "11 min read",
    image: "/images/blog/sred-tax-credits.jpg",
    featured: false,
  ...
  },
  {
    ...
    readTime: "10 min read",
    image: "/images/blog/canexport-programs.jpg",
    featured: false,
  ...
  },
  {
    ...
    readTime: "13 min read",
    image: "/images/blog/canada-regional-development.jpg",
    featured: true,
  ...
  // Tips & Guides (3 posts) - IDs 19-21
  {
    ...
    image: "/images/blog/grant-application-guide.jpg", 
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    image: "/images/blog/grant-writing-secrets.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "March 30, 2025",
    readTime: "12 min read", 
    image: "/images/blog/grant-mistakes-avoid.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  ...
  // Funding Alerts (2 posts) - IDs 22-23
  {
    ...
    date: "October 1, 2025",
    readTime: "7 min read",
    image: "/images/blog/q4-grant-deadlines.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    readTime: "6 min read",
    image: "/images/blog/october-last-chance.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  ...
  // State-Specific (7 posts) - IDs 24-30
  {
    ...
    date: "March 15, 2025",
    readTime: "11 min read",
    image: "/images/blog/texas-business-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "April 8, 2025",
    readTime: "13 min read",
    image: "/images/blog/california-business-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "May 12, 2025",
    readTime: "10 min read",
    image: "/images/blog/new-york-grants.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "June 5, 2025",
    readTime: "9 min read",
    image: "/images/blog/florida-business-grants.jpg", 
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "July 20, 2025",
    readTime: "8 min read",
    image: "/images/blog/illinois-business-development.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "August 10, 2025", 
    readTime: "12 min read",
    image: "/images/blog/michigan-manufacturing.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    readTime: "10 min read", 
    image: "/images/blog/pennsylvania-innovation.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  ...
  // Industry-Specific (3 posts) - IDs 31-33
  {
    ...
    date: "April 25, 2025", 
    readTime: "14 min read",
    image: "/images/blog/manufacturing-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "May 30, 2025",
    readTime: "13 min read",
    image: "/images/blog/healthcare-grants.jpg", 
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "June 15, 2025",
    readTime: "11 min read",
    image: "/images/blog/tech-startup-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  ...
  // Demographic-Specific (3 posts) - IDs 34-36
  {
    ...
    date: "July 8, 2025",
    readTime: "12 min read", 
    image: "/images/blog/women-business-grants.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    date: "August 5, 2025",
    readTime: "11 min read",
    image: "/images/blog/minority-business-grants.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  {
    ...
    readTime: "10 min read",
    image: "/images/blog/rural-business-grants.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  },
  ...
  // Future-Looking (2 posts) - IDs 37-38
  {
    ...
    readTime: "12 min read",
    image: "/images/blog/2026-grant-preview.jpg",
    featured: true,
    content: `Your existing blog post content here...`
  },
  {
    ...
    readTime: "10 min read",
    image: "/images/blog/q1-2026-deadlines.jpg",
    featured: false,
    content: `Your existing blog post content here...`
  }
];
