// lib/data/blog-posts/tips-guides/apply-usa-grants-2025.ts
export default `
  ...
  <div class="bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <a href="/grant-application-review" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-black font-bold py-4 px-8 rounded-lg text-lg transition-colors transform hover:scale-105">
