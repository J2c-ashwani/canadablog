...
const sredTaxCredits2026Post: BlogPost = {
    id: 2053,
    type: 'grant-news',
...
`,
    ...
    }, shortAnswer: "To apply for SR&ED : Maximizing Your Tax Cr 2026, start by reviewing the eligibility criteria and preparing a project proposal. 🇨🇦 The Scientific Research and Experimental Development (SR&ED) program is Canada's largest R&D incentive. Guide to claiming your 35% credit.",
    metrics: [
      ...
      { label: 'Labor', value: 'Eligible', description: 'T4 Salary', color: 'text-blue-600', iconName: 'Users' },
      { label: 'Overhead', value: '65%', description: 'Proxy Method', color: 'text-purple-600', iconName: 'PieChart' }
    ],
    expertTip: {
...
export default sredTaxCredits2026Post;
