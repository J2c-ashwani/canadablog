// lib/data/blog-posts/canada-news/innovation-superclusters-2026.ts
import type { BlogPost } from '../../blogPosts';
import superclustersPost from './innovation-superclusters-2025';
...
`,
    ...
    metrics: [
      ...
      { label: 'Match', value: '50%', description: 'Co-Investment', color: 'text-orange-600', iconName: 'PieChart' },
      { label: 'IP', value: 'Shared', description: 'Collaborative', color: 'text-indigo-600', iconName: 'Lock' }
    ],
    faq: [
      {
