// lib/data/blog-posts/canada-news/digital-transformation-2025.ts
export default `
  ...
  <div class="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <a href="/cdap-digital-consultation" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-blue-800 font-bold py-4 px-8 rounded-lg text-lg transition-colors transform hover:scale-105 border-2 border-yellow-300">
