// lib/data/blog-posts/funding-alerts/october-2025-last-chance.ts
export default `
  ...
  <div class="bg-gradient-to-r from-red-600 via-red-500 to-orange-500 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="/24-hour-sprint" class="bg-yellow-400 hover:bg-yellow-500 text-red-800 font-bold py-3 px-6 rounded-lg text-lg transition-colors border-2 border-yellow-300">
          ⚡ 24-Hour Sprint - $497
        </a>
        <a href="/opportunity-triage" class="bg-white hover:bg-gray-100 text-red-600 font-bold py-3 px-6 rounded-lg text-lg transition-colors border-2 border-white">
