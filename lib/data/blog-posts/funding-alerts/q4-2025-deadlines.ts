// lib/data/blog-posts/funding-alerts/q4-2025-deadlines.ts
export default `
  ...
  <div class="bg-gradient-to-r from-red-600 via-orange-600 to-red-700 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <a href="/emergency-grant-support" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-red-800 font-bold py-4 px-8 rounded-lg text-lg transition-colors transform hover:scale-105 border-2 border-yellow-300">
