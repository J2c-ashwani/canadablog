// lib/data/blog-posts/usa-news/usda-rural-grants-2025.ts
export default `
  ...
  <div class="bg-gradient-to-r from-green-600 via-yellow-500 to-green-600 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <a href="/rural-grant-consultation" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-green-800 font-bold py-4 px-8 rounded-lg text-lg transition-colors transform hover:scale-105 border-2 border-yellow-300">
