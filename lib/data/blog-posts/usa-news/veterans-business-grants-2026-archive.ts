// lib/data/blog-posts/usa-news/veterans-business-grants-2026-archive.ts
...
const post: BlogPost = {
  ...
  "relatedLinks": [
    ...
    },
    {
      ...
      "href": "/blog/healthcare-grants-2026",
      "description": "90% of health startups apply to the wrong program and get rejected. CIHR is for academics — if you..."
    },
    {
      "title": "Lower Competition Edge",
      "href": "/blog/usa-federal-grants",
  ...
  "shortAnswer": "Yes — The federal government has committed $75 million to veteran entrepreneurship. From SBA 7(a) fee waivers to the VetBiz program, learn how to access capital and federal contracting advantages. Funding available: up to $75M (with related programs offering $75).",
