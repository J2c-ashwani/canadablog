// lib/data/blog-posts/usa-news/epa-environmental-justice-2026-archive.ts
...
const post: BlogPost = {
  ...
  "relatedLinks": [
    {
      "title": "Programs",
      "href": "/blog/canada-advanced-manufacturing-innovation-grants",
      "description": "Complete guide to Canadian advanced manufacturing innovation grants. Access $3.1B+ funding through NGen, automation prog..."
    },
    {
      "title": "Stacking Funding",
      "href": "/blog/irap-industrial-research-assistance-program-innovation",
      "description": "Complete guide to IRAP innovation funding from National Research Council Canada. Get 60-80% R&D funding up to $500K with..."
    },
    {
      "title": "Programs",
      "href": "/blog/canada-clean-technology-innovation-grants",
      "description": "Complete guide to Canadian clean technology innovation grants. Access $1.2B+ funding through SDTC (up to $15M), Clean Te..."
    }
  ],
  "content": "",
  "seo": {
    "metaTitle": "EPA Environmental Justice Grants 2026: Complete Guide",
    "metaDescription": "Learn how to qualify and apply for EPA Environmental Justice Grants in 2026. Access active government grants & loans. See if you qualify.",
    "intent": "grant",
    "seoVersion": 1,
    "seoUpdatedAt": "2026-06-30"
  },
  "shortAnswer": "To apply for EPA Environmental Justice Grants 2025: $100M Community Fund, start by reviewing the eligibility criteria and preparing a project proposal. The EPA's Environmental Justice program offers $100 million to community organizations. Fund projects that address pollution and public health in underserved communities. Funding available: up to $100M (with related programs offering $100).",
