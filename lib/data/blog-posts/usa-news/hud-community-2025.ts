// lib/data/blog-posts/usa-news/hud-community-2025.ts
export default `
  ...
  <div class="bg-gradient-to-r from-orange-600 via-yellow-500 to-orange-600 text-white p-8 rounded-lg text-center mb-8">
    ...
    <div class="space-y-4">
      <a href="/cdbg-community-consultation" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-orange-800 font-bold py-4 px-8 rounded-lg text-lg transition-colors transform hover:scale-105 border-2 border-yellow-300">
