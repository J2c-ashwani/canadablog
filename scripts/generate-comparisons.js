...
// 8 Original Comparisons
const ORIGINAL_COMPARISONS = [
  {
    slug: 'irap-vs-sred',
...
const NEW_COMPARISONS = [
  {
    ...
    prog2Id: 'irap-grant',
    points: [
      { dimension: 'Funding Type', prog1Value: 'Retroactive tax refund on year-end filings', prog2Value: 'Pre-approved monthly wage reimbursement grant' },
      { dimension: 'Maximum Cap', prog1Value: 'No maximum cap (based on eligible research spends)', prog2Value: 'Typically capped by ITA approvals ($50k–$500k)' },
      { dimension: 'IP ownership', prog1Value: 'Always retained in-house by company', prog2Value: 'Always retained in-house by company' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Academic Partner', prog1Value: 'Not required (work done entirely by internal staff)', prog2Value: 'Mandatory (co-funded student from accredited university)' },
      { dimension: 'Funding Ratio', prog1Value: '50-80% of eligible employee wages reimbursed', prog2Value: '50% matching co-funding for student internship stipends' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'canexport',
    points: [
      { dimension: 'Eligible Spending', prog1Value: 'Experimental research wages, contractors, materials', prog2Value: 'International trade show travel, marketing, translation' },
      { dimension: 'Reimbursement %', prog1Value: 'Up to 64% of qualified local salaries', prog2Value: '50% of approved international travel and marketing costs' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'sif',
    points: [
      { dimension: 'Target Scale', prog1Value: 'SMEs and startups of any size (minimum $10k spend)', prog2Value: 'Large-scale projects (usually $10M+ total project budget)' },
      { dimension: 'Administration', prog1Value: 'Canada Revenue Agency (CRA)', prog2Value: 'Innovation, Science and Economic Development (ISED) Canada' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'University Lead', prog1Value: 'Grad student works directly in-house at your company', prog2Value: 'University professor leads study in academic laboratory' },
      { dimension: 'Funding Scale', prog1Value: '$15k per unit (half matched by Mitacs)', prog2Value: '$20k to $1M+ (multi-year cost-shared grants)' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Scope of Work', prog1Value: 'E-commerce creation or digital technology adoption plans', prog2Value: 'Workforce retraining, apprentice support, job upskilling' },
      { dimension: 'Region', prog1Value: 'Canada (Federal)', prog2Value: 'Ontario (Provincial)' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'ontario-hiring-grant',
    points: [
      { dimension: 'Capital Flow', prog1Value: 'Continuous monthly claim payouts during project term', prog2Value: 'Lump-sum payment matching once student finishes co-op' },
      { dimension: 'Match Ratio', prog1Value: 'reimburses 50–80% of wages (ongoing)', prog2Value: 'Reimburses up to $5,000–$7,500 of onboarding costs' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Nature of Capital', prog1Value: 'Non-repayable marketing cost reimbursement grant', prog2Value: 'Trade finance, receivables insurance, working capital loans' },
      { dimension: 'Risk Coverage', prog1Value: 'No credit risk protection (covers travel and ad spends)', prog2Value: 'Protects against non-payment by foreign commercial buyers' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'bdc-loans',
    points: [
      { dimension: 'Repayment', prog1Value: 'Non-repayable or conditionally repayable capital', prog2Value: 'Fully repayable commercial debt plus interest' },
      { dimension: 'Eligible Uses', prog1Value: 'High-risk innovation R&D, green pivots, IP build', prog2Value: 'Working capital, technology purchases, real estate' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'irap-grant',
    points: [
      { dimension: 'Jurisdiction', prog1Value: 'Ontario (Provincial)', prog2Value: 'Federal Canada' },
      { dimension: 'Typical Cap', prog1Value: 'Vouchers up to $50,000 (usually matching)', prog2Value: 'Wage grants up to $500,000+' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Ownership Stake', prog1Value: '0% dilution (government takes no equity or seats)', prog2Value: '10–25% equity stake required per investment round' },
      { dimension: 'Matching required', prog1Value: 'Yes (most grants require 20–50% cost-share)', prog2Value: 'No (equity capital provided up front in full)' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'sba-7a-loans',
    points: [
      { dimension: 'Repayment', prog1Value: 'None (if milestones are met and documented)', prog2Value: 'Full repayment required over loan duration (usually 5-10 yrs)' },
      { dimension: 'Interest rate', prog1Value: '0% (no interest, non-repayable)', prog2Value: 'Prime + 1–3% (low-interest government-capped rates)' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Board Control', prog1Value: 'None (no investor control over operations)', prog2Value: 'May require advisory roles or minority seat representation' },
      { dimension: 'Validation Speed', prog1Value: 'Slow (lengthy proposal and review windows)', prog2Value: 'Fast (dependent on personal relationship and terms)' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'irap-grant',
    points: [
      { dimension: 'Financial Liability', prog1Value: 'Yes (capital must be paid back over a fixed term)', prog2Value: 'No (grant is completely free non-repayable cash)' },
      { dimension: 'Security Collateral', prog1Value: 'May require corporate liens or personal guarantees', prog2Value: 'No collateral required (compliance audits only)' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Cash Payout', prog1Value: 'Yes (CRA pays cash refund if company has zero tax liability)', prog2Value: 'No (only reduces actual income tax owed; carried forward)' },
      { dimension: 'Company Stage', prog1Value: 'Ideal for early-stage unprofitable pre-revenue startups', prog2Value: 'Ideal for profitable businesses looking to reduce tax bills' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Clean Tech Focus', prog1Value: 'Generic (software/hardware across any vertical)', prog2Value: 'Deep-tech clean energy, battery, carbon grid technology' },
      { dimension: 'Award Size', prog1Value: 'Phase I up to $275,000', prog2Value: 'Phase I up to $275,000 (often higher for energy hardware)' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Funding Type', prog1Value: 'Grant (broad research and commercial expansion)', prog2Value: 'Procurement Contract (builds specific tech for DoD)' },
      { dimension: 'IP Constraints', prog1Value: 'Startup retains full commercial IP ownership', prog2Value: 'U.S. government retains unlimited rights or licenses' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'sba-7a-loans',
    points: [
      { dimension: 'Capital Access', prog1Value: 'No repayment required (zero interest)', prog2Value: 'Must be paid back with interest to commercial bank' },
      { dimension: 'Use restrictions', prog1Value: 'Highly restricted to approved R&D task milestones', prog2Value: 'Flexible working capital, inventory, property lease' }
    ],
  ...
  },
  {
    ...
    prog2Id: 'nsf-sbir',
    points: [
      { dimension: 'R&D Tax Support', prog1Value: 'Extremely strong (CRA SR&ED refunds up to 64% wages)', prog2Value: 'IRS Form 6765 provides R&D tax offset (usually non-refundable)' },
      { dimension: 'Seed Grant Access', prog1Value: 'Managed through ITA relations (NRC IRAP)', prog2Value: 'Competition cycles with strict federal reviews (SBIR)' }
    ],
  ...
  },
  {
    ...
    points: [
      { dimension: 'Refundability', prog1Value: 'Fully refundable cash refund (CCPC startups)', prog2Value: 'Primarily offsets payroll or corporate taxes owed' },
      { dimension: 'Calculation', prog1Value: 'Up to 64% of qualified local payroll costs refunded', prog2Value: 'Typically yields 6–10% of qualified research spends' }
    ],
...
const ALL_COMPARISONS = [...ORIGINAL_COMPARISONS];

// We want to avoid duplicates and push the new ones
for (const comp of NEW_COMPARISONS) {
  if (!ALL_COMPARISONS.some(c => c.slug === comp.slug)) {
    // Standardize points to have at least 5 points
    const points = [...comp.points];
    const missingPointsCount = 5 - points.length;
    for (let i = 0; i < missingPointsCount; i++) {
      points.push({
    ...
    // Standardize stacking recommendations
    let stacking = comp.stackingRecommendation;
    if (!stacking.includes('<ul>') && !stacking.includes('<ol>')) {
      stacking += `
    ...
    ALL_COMPARISONS.push({
      ...
      prog1Id: comp.prog1Id,
      prog2Id: comp.prog2Id,
      points: points,
      stackingRecommendation: stacking
    });
  }
}

// Generate TS Code
const finalFileContent = `// lib/data/comparisons.ts
...
export const comparisonsDatabase: ProgramComparison[] = ${JSON.stringify(ALL_COMPARISONS, null, 2)};
...
const targetFilePath = path.join(__dirname, '../lib/data/comparisons.ts');
fs.writeFileSync(targetFilePath, finalFileContent, 'utf8');

console.log(`✅ Programmatically wrote ${ALL_COMPARISONS.length} comparisons to ${targetFilePath}`);
