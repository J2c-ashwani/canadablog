...
console.log('After deployment, submit both sitemaps in Google Search Console:')
...
console.log('\nManual shortcut')
console.log('Do not paste every changed URL into GSC. Submit the two sitemaps above, then request indexing only for the URLs printed here.')
