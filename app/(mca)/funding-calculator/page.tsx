        ...
        <div className="mca-calc-container">
          ...
          {showResult && (
            <div className="mca-result-card animated">
              ...
              <div className="mca-result-cta">
                <p>Ready to complete your application? It takes 3 minutes and will not affect your credit score.</p>
                <button onClick={handleApply} className="mca-btn-submit">
                  🔒 Apply Online for ${averageFunding.toLocaleString()} →
                </button>
              </div>
