            ...
            <main className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8 space-y-3 max-w-3xl mx-auto">
                      <ShortAnswerBox 
                        content="Canadian healthcare startups can access IRAP for medical device R&amp;D, NSERC discovery grants, CIHR health research funding ($1.2B annually), provincial health innovation programs, and SR&amp;ED tax credits covering 35–65% of eligible research expenses." 
                        ctaText="Check whether your medtech or health startup qualifies"
                        ctaHref="/calculator?industry=healthcare"
                        ctaContext="healthcare-pilot"
                      />
