            ...
            <main className="container mx-auto px-4 py-12">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="mb-8 space-y-3 max-w-3xl mx-auto">
                      <ShortAnswerBox 
                        content="Canadian agriculture businesses can access AgriInnovate ($10M per project), the Agricultural Clean Technology Program ($2M), AAFC programs, and provincial agri-food grants. The Canadian Agricultural Partnership provides $3B+ over 5 years for farm innovation and sustainability." 
                        ctaText="Check whether your farm or agri-business qualifies for funding"
                        ctaHref="/calculator?industry=agriculture"
                        ctaContext="agri-pilot"
                      />
