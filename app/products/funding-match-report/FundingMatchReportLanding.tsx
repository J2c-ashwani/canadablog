  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 sm:py-20 relative grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          {/* LEFT COLUMN: Pitch */}
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight text-slate-100">
              ...
              <span className="text-emerald-400">Your Business Qualifies For</span>
            </h1>
            ...
            {/* Trust Row */}
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs sm:text-sm text-slate-400 border-t border-slate-800 pt-4">
              <span className="flex items-center gap-1.5"><Zap className="w-4 h-4 text-emerald-400" /> Instant Delivery (&lt;60s)</span>
          ...
          <div className="lg:col-span-5 text-slate-900">
            <StandaloneCheckout
              ...
              price={19}
              productName="Funding Match Report"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-4 gap-6">
            {[
              ...
              { step: '2', title: 'We Match Programs', desc: 'Instant analysis against 1,200+ active programs.', icon: BarChart3 },
