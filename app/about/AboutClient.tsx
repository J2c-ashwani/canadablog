                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-6">
                                <div className="bg-white p-6 rounded-lg shadow-sm">
                                    <h3 className="text-2xl font-bold text-blue-600 mb-2">1,200+</h3>
                    ...
                    <div className="bg-white rounded-lg p-8 shadow-sm mb-16">
                        ...
                        <div className="grid md:grid-cols-4 gap-6">
                            <div className="text-center">
                                ...
                                <p className="text-gray-600 text-sm">Daily monitoring of 1,200+ active programs across federal, state, and provincial levels.</p>
                            </div>
                            <div className="text-center">
