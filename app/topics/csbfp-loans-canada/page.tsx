              ...
              <div className="border-t border-slate-200 pt-8 mt-12 space-y-6">
                <div>
                  ...
                  <div className="flex flex-wrap gap-2.5">
                    <Link href="/topics/csbfp-loans-canada" className="text-xs font-semibold bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-full text-slate-800">CSBFP Loan Details</Link>
                    <Link href="/topics/bdc-small-business-loans" className="text-xs font-semibold bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-full text-slate-800">BDC Small Business Loan</Link>
                  </div>
                </div>
                <div>
