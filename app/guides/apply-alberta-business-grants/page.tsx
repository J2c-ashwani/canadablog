  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <StickyTOC links={[
    { id: "programs", title: "What are the top Alberta grant programs?" },
    { id: "timeline", title: "How long does the Alberta application process take?" },
    { id: "eligibility", title: "Who is eligible for Alberta business grants?" }
  ]} />
