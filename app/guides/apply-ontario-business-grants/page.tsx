  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <StickyTOC links={[
    { id: "programs", title: "What are the top Ontario grant programs?" },
    { id: "timeline", title: "How long does the Ontario application process take?" },
    { id: "eligibility", title: "Who is eligible for Ontario business grants?" }
  ]} />
