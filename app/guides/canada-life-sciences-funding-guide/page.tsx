...
export const metadata: Metadata = {
  ...
  description: "Explore top biotech & life sciences grants canada offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
