            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div id="lead-form" className="bg-white rounded-lg shadow-sm p-8 mt-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Download Your Free WEF Application Kit</h3>
                  <p className="text-gray-600">Get instant access to our professional WEF grant application resources</p>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-3">
                      {[
                        "Complete WEF funding category breakdown",
                        "Business expansion plan templates",
                        "Financial projection frameworks",
                        "Economic impact demonstration guide",
                  ...
                  <div className="bg-gray-50 p-6 rounded-lg">
                    <form className="space-y-4">
                      ...
                      <div>
                        <label className="block text-sm font-semibold mb-1">Annual Revenue</label>
                      ...
                      <div className="flex items-start">
                        ...
                        <span className="text-xs text-gray-600">
                          I agree to receive WEF updates and women entrepreneur grant opportunities. Unsubscribe anytime.
                        </span>
                      </div>
                      <Button 
                        type="submit" 
                      ...
                      >
                        <Download className="w-5 h-5 mr-2" />
                        Download WEF Application Guide Now
                      </Button>
                    </form>
                  </div>
                </div>
