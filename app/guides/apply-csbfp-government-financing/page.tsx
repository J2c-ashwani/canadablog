...
export const metadata: Metadata = {
  title: "CSBFP Government Financing 2026 – Funding Options & Eligibility",
  description: "Explore top csbfp government financing offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <StickyTOC links={[
    { id: "eligibility", title: "Who qualifies for CSBFP loans?" },
    { id: "process", title: "CSBFP Application Timeline" }
  ]} />
