...
export const metadata: Metadata = {
  ...
  description: "Complete guide to technology startup grants in USA. Access SBIR/STTR, NSF, DOE, state tech programs and $2.5M+ in federal innovation funding for tech startups.",
  ...
  openGraph: {
    ...
    url: "https://grantfinder.pro/usa/technology-startup-grants",
