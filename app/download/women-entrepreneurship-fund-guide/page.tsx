...
import { CheckCircle, Download, Shield, FileText, Target, Users, Rocket, Zap } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free WEF Application Guide | Women Entrepreneurship Fund Grant Toolkit 2025",
  description: "Get instant access to our comprehensive Women Entrepreneurship Fund grant application guide with funding category breakdown, expansion templates, and non-repayable grant strategies.",
  keywords: "WEF application guide download, Women Entrepreneurship Fund toolkit, women business grant guide, non-repayable grant application",
}
                ...
                <div>
                  <Card className="border-indigo-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/women-entrepreneurship-fund-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-purple-600 to-indigo-700 hover:from-purple-700 hover:to-indigo-800 text-white font-semibold py-4 text-lg"
                        >
