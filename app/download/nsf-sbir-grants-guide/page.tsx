...
export const metadata: Metadata = {
  title: "Download Free NSF SBIR Grants Guide | Phase I $275K, Phase II $2M Application Toolkit",
  description: "Get instant access to our NSF SBIR/STTR grants guide with Phase I/II proposal templates, technical merit frameworks, commercialization strategies, and application resources.",
  keywords: "NSF SBIR guide, SBIR application templates, Phase I Phase II proposal guide, America's Seed Fund resources",
}
                ...
                <div>
                  <Card className="border-gray-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/nsf-sbir-grants-guide/thank-you" method="GET" className="space-y-4">
