            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="text-center mb-12">
                <Badge className="mb-4 bg-blue-100 text-blue-800 border-blue-200">
                  💻 Free Women Tech Grants Toolkit
                </Badge>
                ...
                <Card className="border-blue-200 bg-white">
                  <CardHeader>
                    <CardTitle className="text-blue-700 text-2xl">
                      📦 What's Included in Your Free Tech Grants Toolkit:
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                      ...
                      <ul className="text-sm text-blue-700 space-y-1">
                        <li>• Canadian AI institute collaboration opportunities</li>
                        <li>• Tech hub ecosystem maps (Toronto, Vancouver, Montreal)</li>
                        <li>• Investor pitch deck template for tech startups</li>
                        <li>• Women in tech networking organizations</li>
                      </ul>
                    </div>
                  </CardContent>
                </Card>
