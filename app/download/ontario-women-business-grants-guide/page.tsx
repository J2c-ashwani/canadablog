...
export const metadata: Metadata = {
  title: "Download Free Ontario Women Business Grants Guide | $800M+ Provincial Support Toolkit",
  description: "Get instant access to our Ontario women business grants guide with program navigator, funding calculator, and application strategies for WES, SBEC, Summer Company, and regional programs.",
  keywords: "Ontario women business grants guide, WES Ontario, SBEC funding, Ontario entrepreneur support",
}
                ...
                <div>
                  <Card className="border-emerald-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/ontario-women-business-grants-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-semibold py-4 text-lg"
                        >
