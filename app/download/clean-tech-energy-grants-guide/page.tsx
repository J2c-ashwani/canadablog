...
import { CheckCircle, Download, Shield, Sparkles, Users, MapPin, DollarSign, Target, Clock, Award, FileText, TrendingUp, Sun, Battery, Wind, Leaf, Loader2 } from "lucide-react"
    ...
    try {
      const response = await fetch("/api/download", {
        ...
        body: JSON.stringify({
          ...
          guideName: "Clean Tech & Energy Grants Guide",
          industry: formData.category || "Clean Technology",
          country: "USA",
      ...
      if (response.ok) {
        router.push("/download/clean-tech-energy-grants-guide/thank-you")
      } else {
                    ...
                    <CardContent className="pt-6">
                      ...
                      <div>
                        ...
                        <Button 
                          ...
                          className="w-full bg-gradient-to-r from-green-600 to-emerald-700 hover:from-green-700 hover:to-emerald-800 text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {isSubmitting ? (
                            <>
