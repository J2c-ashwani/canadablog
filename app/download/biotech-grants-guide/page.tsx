...
import { CheckCircle, Download, Shield, Sparkles, Users, MapPin, DollarSign, Target, Clock, Award, FileText, TrendingUp } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free Biotech & Life Sciences Grants Guide | $306K NIH SBIR Phase I, $2M Phase II Application Templates",
  description: "Get instant access to our biotech grants guide with NIH SBIR Phase I $306K templates, Phase II $2M strategies, FDA Orphan Drug programs, state life sciences centers. Complete application toolkit for therapeutics, medical devices, and diagnostics.",
  keywords: "biotech grants guide, life sciences startup grants NIH SBIR, therapeutics application templates, medical device grants",
}
              ...
              <div className="grid lg:grid-cols-5 gap-8 items-start">
                ...
                <div className="lg:col-span-2">
                  <Card className="border-gray-200 bg-white shadow-2xl sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/biotech-life-sciences-grants-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-teal-600 to-cyan-700 hover:from-teal-700 hover:to-cyan-800 text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all"
                        >
                          <Download className="w-5 h-5 mr-2" />
