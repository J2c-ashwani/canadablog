...
import { CheckCircle, Download, Shield, FileText, Target, Users, Calendar, Zap } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free Alberta Women Business Grants Guide | $580M Energy & Innovation Toolkit",
  description: "Get instant access to our Alberta women business grants guide with AWE programs, Women Building Futures, and energy sector women funding strategies.",
  keywords: "Alberta women business grants guide, AWE Alberta, Women Building Futures, energy sector women entrepreneurs",
}
                ...
                <div>
                  <Card className="border-orange-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/alberta-women-business-grants-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-red-600 to-orange-700 hover:from-red-700 hover:to-orange-800 text-white font-semibold py-4 text-lg"
                        >
