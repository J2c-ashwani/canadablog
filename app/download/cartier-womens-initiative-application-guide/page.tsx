...
import { CheckCircle, Download, Shield, FileText, Target, Users, Calendar, Globe } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free Cartier Women's Initiative Application Guide | UN SDG Impact Toolkit",
  description: "Get instant access to our Cartier Women's Initiative application toolkit with UN SDG alignment framework, impact articulation templates, and $100K award strategies.",
  keywords: "Cartier Women's Initiative guide, impact entrepreneur toolkit, UN SDG framework, social enterprise application",
}
                ...
                <div>
                  <Card className="border-indigo-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/cartier-womens-initiative-application-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-purple-800 to-indigo-900 hover:from-purple-900 hover:to-indigo-950 text-white font-semibold py-4 text-lg"
                        >
