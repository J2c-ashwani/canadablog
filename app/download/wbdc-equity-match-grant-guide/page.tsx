...
import { CheckCircle, Download, Shield, FileText, Target, Users, Calendar, Calculator } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free WBDC Equity Match Grant Guide | 1:1 Match Calculator & Application Toolkit",
  description: "Get instant access to our WBDC Equity Match Grant toolkit with 1:1 match calculator, quarterly deadline tracker, and growth project planning templates.",
  keywords: "WBDC Equity Match Grant guide, Connecticut women grants, equity match calculator, quarterly grant applications",
}
                ...
                <div>
                  <Card className="border-indigo-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/wbdc-equity-match-grant-guide/thank-you" method="GET" className="space-y-4">
