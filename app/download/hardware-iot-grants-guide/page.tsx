...
import { CheckCircle, Download, Shield, Sparkles, Users, MapPin, DollarSign, Target, Clock, Award, FileText, TrendingUp, Wifi, Cpu, Cog } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free Hardware & IoT Grants Guide | $305K NSF SBIR Phase I, $1.25M Phase II Application Templates",
  description: "Get instant access to our hardware and IoT grants guide with NSF SBIR Phase I $305K templates, Phase II $1.25M strategies, DOD electronics programs, manufacturing support. Complete toolkit for connected devices, sensors, and robotics.",
  keywords: "hardware grants guide, IoT startup grants NSF SBIR, electronics application templates, sensor technology grants",
}
              ...
              <div className="grid lg:grid-cols-5 gap-8 items-start">
                ...
                <div className="lg:col-span-2">
                  <Card className="border-gray-200 bg-white shadow-2xl sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/hardware-iot-grants-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-orange-600 to-amber-700 hover:from-orange-700 hover:to-amber-800 text-white font-bold py-4 text-lg shadow-lg hover:shadow-xl transition-all"
                        >
                          <Download className="w-5 h-5 mr-2" />
