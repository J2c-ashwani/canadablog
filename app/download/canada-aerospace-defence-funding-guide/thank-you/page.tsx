          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Your Aerospace Funding Toolkit is On Its Way!
              </h1>
              
              <p className="text-xl text-gray-600 mb-8">
                Check your email for instant access to the Canada Aerospace Grants Application Toolkit. 
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Review the CSA templates and IDEaS defence innovation tools to determine which aerospace programs match your technology development stage.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Use the aerospace ROI calculators and certification guides to build your funding application and technical documentation.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Book your complimentary 30-minute aerospace funding strategy consultation with our space technology grant specialists.</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button variant="outline" asChild>
                    <Link href="/blog/canada-aerospace-defence-innovation-grants">
                      Read Complete Aerospace Guide
                    </Link>
                  </Button>
                  <Button variant="outline" asChild>
