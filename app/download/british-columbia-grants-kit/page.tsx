...
import { CheckCircle, Download, FileText, Calculator, Users, Shield, Building, Mountain, Award, Loader2 } from "lucide-react"
    ...
    try {
      const response = await fetch("/api/download", {
        ...
        body: JSON.stringify({
          ...
          guideName: "BC Business Grants Kit",
          industry: formData.industry || "Business",
          country: "Canada",
          state: formData.bcRegion,
          additionalNotes: `Role: ${formData.role}, Program: ${formData.targetProgram}, Funding: ${formData.fundingAmount}, Stage: ${formData.businessStage}, Focus: ${formData.innovationFocus}, Challenges: ${formData.challenges || "N/A"}`,
        }),
      })
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-lg sticky top-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      <div>
                        ...
                        <Select 
                          required
                          value={formData.bcRegion}
                          onValueChange={(value) => setFormData({ ...formData, bcRegion: value })}
                        >
                          <SelectTrigger className="mt-1">
