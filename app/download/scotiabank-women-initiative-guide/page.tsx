...
import { CheckCircle, Download, Shield, FileText, Target, Users, Calendar, DollarSign } from "lucide-react"
import Link from "next/link"
import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "Download Free Scotiabank Women Initiative Guide | Capital + Mentorship Toolkit",
  description: "Get instant access to our Scotiabank Women Initiative guide with capital access strategies, mentorship program details, and educational resource overview.",
  keywords: "Scotiabank Women Initiative guide, women business banking, capital access toolkit, mentorship programs",
}
                ...
                <div>
                  <Card className="border-orange-200 bg-white sticky top-4">
                    ...
                    <CardContent className="pt-6">
                      <form action="/download/scotiabank-women-initiative-guide/thank-you" method="GET" className="space-y-4">
                        ...
                        <Button 
                          type="submit" 
                          className="w-full bg-gradient-to-r from-red-700 to-red-900 hover:from-red-800 hover:to-red-950 text-white font-semibold py-4 text-lg"
                        >
