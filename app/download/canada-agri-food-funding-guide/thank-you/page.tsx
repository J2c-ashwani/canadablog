          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Your Agri-Food Funding Toolkit is On Its Way!
              </h1>
              
              <p className="text-xl text-gray-600 mb-8">
                Check your email for instant access to the Canada Agriculture Grants Application Toolkit. 
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Review the AgriInnovate templates and CAP funding tools to determine which agriculture programs match your farm technology development stage.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Use the precision agriculture ROI calculators and farm impact assessment tools to build your funding application and business case.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Book your complimentary 30-minute agri-food funding strategy consultation with our agriculture grant specialists.</p>
                  </CardContent>
                </Card>
              </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button variant="outline" asChild>
                    <Link href="/blog/canada-agri-food-technology-innovation-grants">
                      Read Complete Agriculture Guide
                    </Link>
                  </Button>
                  <Button variant="outline" asChild>
