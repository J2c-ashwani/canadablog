          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-4xl font-bold text-gray-900 mb-4">
                Your DOE SBIR Clean Energy Grants Toolkit is On Its Way!
              </h1>
              
              <p className="text-xl text-gray-600 mb-8">
                Check your email for instant access to the DOE SBIR/STTR Clean Energy Grants Application Guide with 
                Phase I/II proposal templates, topic area strategies, commercialization frameworks, and utility partnership 
                guides. If you don't see it in a few minutes, check your spam folder.
              </p>
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-12">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Use the Phase I proposal template and energy mission alignment framework to prepare your $200K DOE SBIR application.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Review the DOE topic area strategies and identify which energy sector best aligns with your clean technology innovation.</p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Schedule your complimentary strategy call with our DOE SBIR specialists to optimize your clean energy proposal.</p>
                  </CardContent>
                </Card>
              </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button variant="outline" asChild>
                    <Link href="/blog/doe-sbir-clean-energy-grants">
                      Read Complete DOE SBIR Blog Post
                    </Link>
                  </Button>
                  <Button variant="outline" asChild>
