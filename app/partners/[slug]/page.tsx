        ...
        <section className="bg-slate-50 border-t border-b border-slate-200 py-10">
          <div className="container mx-auto px-4 text-center sm:px-6 lg:px-8">
            ...
            <p className="text-sm text-slate-600 max-w-3xl mx-auto leading-relaxed">
              FSI Digital operates in strict compliance with **TCPA (Telephone Consumer Protection Act)**, **CASL (Canada Anti-Spam Legislation)**, **GDPR**, and **CCPA** guidelines. Every lead profile carries stored checkboxes certifying express written consent, IP tracking verification, and time-stamped authorization records.
            </p>
          </div>
        </section>
