...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Leaf, Sun, Recycle, MapPin, Briefcase, HelpCircle, TrendingUp, Zap, Rocket } from 'lucide-react'
...
export default function CanadaCleanTechnologyEnvironmentGrantsGuidePage() {
  ...
  const postData = getBlogPostBySlug("canada-clean-technology-environment-grants-guide");
