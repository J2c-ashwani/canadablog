...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Waves, Film, Leaf, Zap, Mountain, Sailboat, ExternalLink, ArrowRight, Building, HelpCircle, TrendingUp, Users, Award, Shield, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function BritishColumbiaInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("british-columbia-innovation-grants");
