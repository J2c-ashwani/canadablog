...
import { CheckCircle, DollarSign, Target, AlertTriangle, FileText, Clock, ChevronRight, ExternalLink, BookOpen, HelpCircle, Building, Users, TrendingUp, Lightbulb, Code, Rocket, Shield, Award, Terminal, Briefcase, Heart, Zap, MapPin } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function SoftwareSaaSGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("software-saas-startup-grants");
