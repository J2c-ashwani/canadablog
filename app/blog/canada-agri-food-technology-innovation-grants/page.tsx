...
import { CheckCircle, Target, Building, HelpCircle, BookOpen, ExternalLink, Leaf, TrendingUp, DollarSign, Factory, ArrowRight, Clock, Users, AlertCircle, Lightbulb, Award, FileText, MapPin, Zap, Sprout, Droplets, Sun, Tractor, FlaskConical, Shield, Rocket } from 'lucide-react'
...
export default function AgrifoodTechGrantsGuidePage() {
  ...
  const postData = getBlogPostBySlug("canada-agri-food-technology-innovation-grants");
