...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Factory, Settings, Cog, MapPin, Briefcase, HelpCircle, TrendingUp, Zap, Rocket } from 'lucide-react'
...
export const metadata: Metadata = {
  title: "Canada Manufacturing & Industry Grants 2026 – Funding up to $100K",
...
export default function CanadaManufacturingIndustryGrantsGuidePage() {
  ...
  const postData = getBlogPostBySlug("canada-manufacturing-industry-grants-guide");
