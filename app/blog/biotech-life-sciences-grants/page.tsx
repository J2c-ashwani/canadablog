...
import { CheckCircle, DollarSign, Target, Microscope, Dna, FlaskConical, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Stethoscope, Briefcase, TrendingUp, Users, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function BiotechLifeSciencesGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("biotech-life-sciences-grants");
