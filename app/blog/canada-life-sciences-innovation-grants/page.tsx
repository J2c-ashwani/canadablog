...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, Download, Heart, Pill, Microscope, Dna, Stethoscope, Syringe, ExternalLink, ArrowRight, HelpCircle, TrendingUp, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function CanadaLifeSciencesInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("canada-life-sciences-innovation-grants");
