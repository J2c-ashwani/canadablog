...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, MapPin, Home, Globe, Briefcase, HelpCircle, TrendingUp, Zap, Rocket } from 'lucide-react'
...
export default function CanadaRegionalEconomicDevelopmentGrantsGuidePage() {
  ...
  const postData = getBlogPostBySlug("canada-regional-economic-development-grants-guide");
  ...
  const faqData = [
    {
      question: "What are the Regional Development Agencies (RDAs) in Canada?",
      answer: "Canada has 7 RDAs: ACOA (Atlantic), CED (Quebec), FedDev Ontario (Southern Ontario), FedNor (Northern Ontario), PrairiesCan (Prairies), PacifiCan (BC), and CanNor (Territories)."
    },
    {
      question: "What types of projects do RDAs fund?",
      answer: "RDAs fund projects that support economic growth, innovation, community development, and job creation. This includes business scale-up, tourism, and adopting new technologies."
    },
    {
      question: "Can non-profits apply for RDA funding?",
      answer: "Yes, many RDA programs are open to non-profits, municipalities, and Indigenous organizations for community economic development projects."
    },
    {
      question: "Is RDA funding repayable?",
      answer: "It depends. Contributions to businesses are often repayable (interest-free loans), while contributions to non-profits are typically non-repayable."
    }
  ];
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="py-12 bg-orange-50 border-b border-orange-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">❓ Common Questions About Regional Development</h2>
              <div className="grid md:grid-cols-2 gap-4">
                <a href="#programs" className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                  <h3 className="font-semibold text-orange-700">What is my local RDA?</h3>
                  <p className="text-sm text-gray-600 mt-1">ACOA, FedDev, PrairiesCan, or others.</p>
                </a>
                <a href="#programs" className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                  <h3 className="font-semibold text-orange-700">Can non-profits apply?</h3>
                  <p className="text-sm text-gray-600 mt-1">Yes, for community economic projects.</p>
                </a>
                <a href="#programs" className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                  <h3 className="font-semibold text-orange-700">Is funding repayable?</h3>
                  <p className="text-sm text-gray-600 mt-1">Business loans are repayable; non-profit grants often aren't.</p>
                </a>
                <a href="#faq" className="p-4 bg-white rounded-lg shadow-sm hover:shadow-md transition border border-gray-100">
                  <h3 className="font-semibold text-orange-700">What projects are eligible?</h3>
                  <p className="text-sm text-gray-600 mt-1">Scale-up, innovation, and diversification.</p>
                </a>
              </div>
            </div>
          </div>
                  ...
                  <Card key={index} className="border-orange-100">
                    <CardHeader>
                      <CardTitle className="flex items-start text-lg text-gray-800">
                        <HelpCircle className="w-6 h-6 text-orange-600 mr-3 shrink-0" />
                        {faq.question}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
