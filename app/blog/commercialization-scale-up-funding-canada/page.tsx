...
import { CheckCircle, DollarSign, Target, Rocket, ShoppingCart, Globe, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Gavel, Briefcase, TrendingUp, Users, Zap, MapPin, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function CommercializationFundingGuide() {
  ...
  const postData = getBlogPostBySlug("commercialization-scale-up-funding-canada");
