...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, MapPin, HelpCircle, TrendingUp, Zap, Rocket } from 'lucide-react'
...
export default function RDAGovernmentGrantsBlogPage() {
  ...
  const postData = getBlogPostBySlug("regional-development-agencies-government-grants");
