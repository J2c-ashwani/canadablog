...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Lightbulb, BookOpen, FlaskConical, GraduationCap, ExternalLink, HelpCircle, TrendingUp, Users, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function IdeationResearchFundingCanadaPage() {
  ...
  const postData = getBlogPostBySlug("ideation-research-funding-canada");
