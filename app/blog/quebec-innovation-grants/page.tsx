...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Plane, Gamepad2, Microscope, Zap, Building2, TrendingUp, ExternalLink, ArrowRight, Building, Users, Award, Shield, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function QuebecInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("quebec-innovation-grants");
