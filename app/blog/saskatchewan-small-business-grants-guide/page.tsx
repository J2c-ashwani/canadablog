    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section id="overview" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Saskatchewan Business Funding Overview</h2>
        ...
        <section id="programs" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12">Major Saskatchewan Small Business Grant Programs</h2>
        ...
        <section id="industries" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Industry-Specific Grants in Saskatchewan</h2>
        ...
        <section id="cities" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Saskatoon & Regina Business Programs</h2>
        ...
        <section id="alternatives" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Alternatives to Saskatchewan Business Grants</h2>
              ...
              <div className="space-y-4">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="font-bold text-lg flex items-start">
                      <HelpCircle className="w-5 h-5 text-yellow-600 mr-2 mt-1 flex-shrink-0" />
                      Can startups apply for Saskatchewan grants?
                    </h3>
                    <p className="text-gray-700 mt-2 ml-7">
                      Yes, Innovation Saskatchewan and accelerator programs specifically
                      target early-stage companies. Agricultural grants typically require
                ...
                <Card>
                  <CardContent className="pt-6">
                    <h3 className="font-bold text-lg flex items-start">
                      <HelpCircle className="w-5 h-5 text-yellow-600 mr-2 mt-1 flex-shrink-0" />
                      How competitive are Saskatchewan business grants?
                    </h3>
                    <p className="text-gray-700 mt-2 ml-7">
                      Saskatchewan has less competition than larger provinces. Well-prepared
                      applications in priority sectors see 30-40% approval rates—above
                      national averages.
                    </p>
                  </CardContent>
                </Card>
