...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Percent, MapPin, Briefcase, HelpCircle, TrendingUp, Zap, Rocket } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function CSBFPGovernmentGrantsBlogPage() {
  ...
  const postData = getBlogPostBySlug("csbfp-canada-small-business-financing-program-government-grants");
