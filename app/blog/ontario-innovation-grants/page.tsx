...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Building, Factory, Microscope, Brain, Leaf, TrendingUp, ExternalLink, ArrowRight, HelpCircle, Users, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function OntarioInnovationGrantsTaxCreditsPage() {
  ...
  const postData = getBlogPostBySlug("ontario-innovation-grants");
