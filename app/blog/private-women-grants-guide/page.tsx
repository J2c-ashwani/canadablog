...
import { ExternalLink, Clock, DollarSign, Target, CheckCircle, AlertCircle, Sparkles, Gift, Award, HelpCircle, MapPin, Briefcase, Shield, Users, Heart, TrendingUp, Zap, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function PrivateWomenGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("private-women-grants-guide");
