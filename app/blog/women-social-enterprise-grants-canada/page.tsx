...
export const metadata: Metadata = {
  ...
  keywords: "women social enterprise grants Canada 2026, social impact funding women Ontario, community development grants Toronto, purpose-driven business support Vancouver, non-profit funding women Montreal, impact investment Calgary, social innovation grants women Quebec, women social entrepreneurs BC, community business grants Alberta, social finance funding women Canada, how to apply for women social enterprise grants canada, women social enterprise grants canada eligibility 2026, step by step women social enterprise grants canada application guide, best women social enterprise grants canada for small business Canada, best grants for women entrepreneurs Canada 2026, women owned business funding eligibility, am I eligible for women social enterprise grants canada, women social enterprise grants canada deadline 2026",
  openGraph: {
...
export default function WomenSocialEnterpriseGrantsCanadaPage() {
  ...
  const postData = getBlogPostBySlug("women-social-enterprise-grants-canada");
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Link href="/blog/top-10-no-equity-grants-black-female-entrepreneurs" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-purple-500 hover:shadow-lg transition-all group">
                ...
                <Link href="/blog/indigenous-women-business-grants-canada" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-purple-500 hover:shadow-lg transition-all group">
                ...
                <Link href="/blog/women-entrepreneurship-grants-2026" className="block p-6 bg-white rounded-xl border border-gray-200 hover:border-purple-500 hover:shadow-lg transition-all group">
