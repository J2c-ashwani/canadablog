...
import { CheckCircle, Target, Building, HelpCircle, BookOpen, ExternalLink, Users, Handshake, DollarSign, TrendingUp, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function WomensBusinessCentersGuidePage() {
  ...
  const postData = getBlogPostBySlug("women-business-centers-guide");
