...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Zap, Brain, Heart, Fuel, Wind, Factory, ExternalLink, ArrowRight, Building, HelpCircle, TrendingUp, Users, Award, Shield, MapPin, Rocket, FileText } from 'lucide-react'
...
export const metadata: Metadata = {
  title: "Alberta Innovation Grants & Funding 2026 – Funding up to $100K",
  description: "Explore top alberta innovation grants & funding offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function AlbertaInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("alberta-innovation-grants");
