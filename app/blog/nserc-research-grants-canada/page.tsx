...
import { CheckCircle, DollarSign, Target, Lightbulb, Users, Globe, BookOpen, GraduationCap, Microscope, Award, ArrowRight, HelpCircle, FileText, AlertCircle, Building, Shield, Clock, Send, Download, TrendingUp, Zap, MapPin, Rocket } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function NSERCResearchGrantsGuidePage() {
  ...
  const postData = getBlogPostBySlug("nserc-research-grants-canada");
