...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Wheat, Mountain, Wind, Zap, Factory, Sprout, ExternalLink, ArrowRight, Building, HelpCircle, TrendingUp, Users, Award, Shield, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function PrairieProvincesInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("prairie-provinces-innovation-grants");
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-sm">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link href="/blog/saskatchewan-business-grants-2026" className="flex items-center text-amber-600 hover:underline">
                        Saskatchewan Business Grants Guide <ArrowRight className="w-4 h-4 ml-1" />
                      </Link>
                    </li>
                    <li>
                      <Link href="/blog/manitoba-business-grants-2026" className="flex items-center text-amber-600 hover:underline">
