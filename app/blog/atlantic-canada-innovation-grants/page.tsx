...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Anchor, Waves, Wind, Plane, Ship, Zap, ExternalLink, ArrowRight, Building, HelpCircle, TrendingUp, Users, Award, Shield, MapPin, Rocket, FileText } from 'lucide-react'
...
export const metadata: Metadata = {
  title: "Atlantic Canada Innovation Grants & Funding 2026 (2026 Guide)",
  description: "Explore top atlantic canada innovation grants & funding offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function AtlanticCanadaInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("atlantic-canada-innovation-grants");
