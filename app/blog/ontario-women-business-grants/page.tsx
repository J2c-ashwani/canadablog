...
import { CheckCircle, DollarSign, Target, Heart, Users, Megaphone, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Star, Briefcase, MapPin, TrendingUp, Zap, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function OntarioWomenBusinessGrants() {
  ...
  const postData = getBlogPostBySlug("ontario-women-business-grants");
