...
import { CheckCircle, DollarSign, Target, AlertCircle, Building, Clock, Download, TrendingUp, HelpCircle, BookOpen, ExternalLink, Award, Users, Heart, Briefcase, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function ScotiabankWomenInitiativePage() {
  ...
  const postData = getBlogPostBySlug("scotiabank-women-initiative");
