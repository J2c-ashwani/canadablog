        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 mb-6">DoD is one of 11 agencies offering SBIR/STTR funding. Explore sector-specific guides:</p>
              <div className="grid md:grid-cols-3 gap-4">
                <Link href="/blog/sbir-sttr-complete-guide" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
                  <h3 className="font-bold mb-1">SBIR/STTR Overview</h3>
                  <p className="text-sm text-gray-600">Full program guide →</p>
                </Link>
                <Link href="/blog/doe-sbir-clean-energy-grants" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
                  <h3 className="font-bold mb-1">DOE SBIR</h3>
                  <p className="text-sm text-gray-600">Clean energy →</p>
                </Link>
                <Link href="/blog/nasa-sbir-space-tech-grants" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
                  <h3 className="font-bold mb-1">NASA SBIR</h3>
                  <p className="text-sm text-gray-600">Space technology →</p>
                </Link>
                <Link href="/blog/nih-sbir-biotech-grants" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
                  <h3 className="font-bold mb-1">NIH SBIR</h3>
                  <p className="text-sm text-gray-600">Biotech &amp; health →</p>
                </Link>
                <Link href="/blog/nsf-sbir-grants-technology-startups" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
                  <h3 className="font-bold mb-1">NSF SBIR</h3>
                  <p className="text-sm text-gray-600">Deep tech →</p>
                </Link>
                <Link href="/blog/usda-sbir-agtech-grants" className="p-4 bg-white rounded-lg border hover:border-slate-500 transition-all">
