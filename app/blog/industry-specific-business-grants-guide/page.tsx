          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                <Link href="/blog/alberta-business-grants-2025" className="flex items-center p-4 bg-white rounded-lg border hover:border-teal-500 transition-all"><Building2 className="w-5 h-5 text-blue-500 mr-3" /><span>Alberta Grants</span><ExternalLink className="w-4 h-4 text-gray-400 ml-auto" /></Link>
              </div>
