...
export const metadata: Metadata = {
  ...
  keywords: "Indigenous women business grants Canada 2026, NACCA funding First Nations, Aboriginal Entrepreneurship Program women, IWEF Indigenous Women Entrepreneurship Fund, First Nations business loans Métis Inuit women entrepreneurs, cultural enterprise grants Canada, Indigenous Financial Institutions IFI, women entrepreneurship loan fund $50K, Indigenous business development support Ontario BC Alberta Manitoba Saskatchewan, how to apply for indigenous women business grants canada, indigenous women business grants canada eligibility 2026, step by step indigenous women business grants canada application guide, best indigenous women business grants canada for small business Canada, best grants for women entrepreneurs Canada 2026, women owned business funding eligibility, am I eligible for indigenous women business grants canada, indigenous women business grants canada deadline 2026",
  openGraph: {
...
export default function IndigenousWomenBusinessGrantsCanadaPage() {
  ...
  const postData = getBlogPostBySlug("indigenous-women-business-grants-canada");
