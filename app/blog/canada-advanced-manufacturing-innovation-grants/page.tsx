...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, Download, Factory, Cog, Cpu, TrendingUp, ExternalLink, ArrowRight, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function CanadaAdvancedManufacturingInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("canada-advanced-manufacturing-innovation-grants");
