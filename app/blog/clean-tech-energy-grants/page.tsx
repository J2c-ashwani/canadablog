...
import { CheckCircle, DollarSign, Target, Leaf, Zap, Wind, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Factory, Briefcase, TrendingUp, Users, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function CleanTechEnergyGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("clean-tech-energy-grants");
