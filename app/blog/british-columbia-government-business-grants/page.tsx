    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section id="overview" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">BC Government Funding Overview</h2>
              <p className="text-gray-700 leading-relaxed mb-6">British Columbia offers one of Canada&apos;s most diverse funding ecosystems, with over $1.8 billion annually available through provincial and federal programs. BC&apos;s focus areas include clean technology, digital innovation, creative industries (particularly film), and export development.</p>
        ...
        <section id="innovate-bc" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Innovate BC Programs</h2>
        ...
        <section id="cleanbc" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">CleanBC Programs</h2>
        ...
        <section id="creative" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Creative BC &amp; Film Tax Credits</h2>
        ...
        <section id="pacifican" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">PacifiCan Federal Programs</h2>
        ...
        <section id="success" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div><h3 className="font-bold mb-3 text-green-700">✅ Winning Approaches</h3><ul className="space-y-2 text-sm"><li className="flex items-start"><CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5" /><span>Show clear BC economic impact (jobs, exports, IP)</span></li><li className="flex items-start"><CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5" /><span>Stack CleanBC with federal programs when allowed</span></li><li className="flex items-start"><CheckCircle className="w-4 h-4 text-green-500 mr-2 mt-0.5" /><span>Consider regional expansion for priority scoring</span></li></ul></div>
        ...
        <section id="faqs" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <Card><CardContent className="pt-6"><h3 className="font-bold flex items-start"><HelpCircle className="w-5 h-5 text-blue-600 mr-2 mt-0.5" />What&apos;s the difference between Innovate BC and PacifiCan?</h3><p className="text-gray-700 mt-2 ml-7">Innovate BC is provincial (grants), while PacifiCan is federal (interest-free loans). Innovate BC funds earlier-stage R&amp;D; PacifiCan funds scale-up and expansion. They can often be combined.</p></CardContent></Card>
                <Card><CardContent className="pt-6"><h3 className="font-bold flex items-start"><HelpCircle className="w-5 h-5 text-blue-600 mr-2 mt-0.5" />Can I get BC funding if I&apos;m not in Vancouver?</h3><p className="text-gray-700 mt-2 ml-7">Yes—and often with priority! Many programs give preference to businesses outside Metro Vancouver to encourage regional economic development.</p></CardContent></Card>
                <Card><CardContent className="pt-6"><h3 className="font-bold flex items-start"><HelpCircle className="w-5 h-5 text-blue-600 mr-2 mt-0.5" />Are there grants for film production in BC?</h3><p className="text-gray-700 mt-2 ml-7">BC offers some of North America&apos;s most competitive film tax credits (28-35%+). Contact Creative BC for guidance on structuring your production to maximize credits.</p></CardContent></Card>
              </div>
            </div>
          </div>
        </section>
