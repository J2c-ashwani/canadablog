...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Calculator, TrendingUp, Send, Lightbulb, Heart, Sparkles, Zap, Rocket, Calendar, HelpCircle, MapPin } from 'lucide-react'
...
export default function WBDCEquityMatchGrantGuidePage() {
  ...
  const postData = getBlogPostBySlug("wbdc-equity-match-grant-women");
