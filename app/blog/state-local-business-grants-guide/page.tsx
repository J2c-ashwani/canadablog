...
import { ExternalLink, Clock, DollarSign, Target, CheckCircle, AlertCircle, MapPin, Users, Building2, BookOpen, HelpCircle, ChevronRight, AlertTriangle, TrendingUp, Award, Shield, Zap, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function StateLocalBusinessGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("state-local-business-grants-guide");
