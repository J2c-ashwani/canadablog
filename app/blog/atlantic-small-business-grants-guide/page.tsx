...
export const metadata: Metadata = {
  title: "Atlantic Canada Small Business Grants 2026 – Funding up to $100K",
  description: "Explore top atlantic canada small business grants offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
  keywords: "Atlantic Canada small business grants, ACOA business funding, Nova Scotia Small Business Fund, New Brunswick Innovation Fund, PEI Development Fund, Newfoundland business grants, Halifax business grants, ocean technology funding, how to apply for ACOA grants 2026, ACOA eligibility requirements, how to apply for atlantic small business grants guide, atlantic small business grants guide eligibility 2026, step by step atlantic small business grants guide application guide, best atlantic small business grants guide for small business Canada, am I eligible for atlantic small business grants guide, atlantic small business grants guide deadline 2026",
}
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white dark:bg-neutral-900 rounded-xl p-6 shadow-sm border border-indigo-200">
              <p className="text-gray-800 dark:text-gray-200 text-base leading-relaxed">
                ...
                In Atlantic Canada (NS, NB, PEI, NL), the federal government plays a much larger role in local funding than in other provinces. The <strong>Atlantic Canada Opportunities Agency (ACOA)</strong> is the gatekeeper for major funding, specifically through the <strong>BDP (Business Development Program)</strong> which offers up to $500K in unconditionally interest-free, repayable contributions. If you are in Halifax, OceanTech is the golden ticket. Simply put: contact your local ACOA office before you spend a dime.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-6">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <GrantSuccessTable
                title="Top Atlantic Funding Pillars"
                metrics={[
                  { label: "ACOA BDP", value: "$50K-$500K", description: "Interest-free expansion loans", icon: <Building className="w-5 h-5" />, color: "text-indigo-600" },
                  { label: "ACOA REGI", value: "Up to $1M", description: "Innovation & R&D project funding", icon: <Zap className="w-5 h-5" />, color: "text-blue-600" },
                  { label: "Provincial Funds", value: "Variable", description: "Targeted sector/job creation (NB IF, NS BI)", icon: <Target className="w-5 h-5" />, color: "text-green-600" },
                  { label: "OceanTech", value: "Priority", description: "Massive focus in NS & NL", icon: <Anchor className="w-5 h-5" />, color: "text-cyan-600" }
                ]}
              />
            </div>
          </div>
        ...
        <section className="py-6">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <ExpertTipBox type="tip" title="Build a Relationship with ACOA First">
                <p>Unlike massive Ontario or BC granting agencies where you just upload a PDF to an anonymous portal, ACOA operates on relationships. Your assigned ACOA program officer will literally champion your application to the committee. Call them BEFORE you start writing your application to align your project with their current quarterly budget priorities.</p>
              </ExpertTipBox>
            </div>
          </div>
        </section>
