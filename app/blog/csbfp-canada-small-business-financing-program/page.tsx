...
export const metadata: Metadata = {
  ...
  keywords: "CSBFP, Canada Small Business Financing Program, business loans Canada, government guaranteed loans, SME financing Canada, small business loans, how to apply for CSBFP grants 2026, CSBFP eligibility requirements, how to apply for csbfp canada small business financing program, csbfp canada small business financing program eligibility 2026, step by step csbfp canada small business financing program application guide, best csbfp canada small business financing program for small business Canada, am I eligible for csbfp canada small business financing program, csbfp canada small business financing program deadline 2026",
}
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                <Link href="/blog/bc-business-grants-2026" className="flex items-center p-4 bg-white rounded-lg border hover:border-blue-500 transition-all"><Building className="w-5 h-5 text-blue-600 mr-3" /><span>BC Grants</span><ExternalLink className="w-4 h-4 text-gray-400 ml-auto" /></Link>
                <Link href="/blog/alberta-business-grants-2026" className="flex items-center p-4 bg-white rounded-lg border hover:border-blue-500 transition-all"><Building className="w-5 h-5 text-blue-500 mr-3" /><span>Alberta Grants</span><ExternalLink className="w-4 h-4 text-gray-400 ml-auto" /></Link>
                <Link href="/blog/quebec-business-grants-2026" className="flex items-center p-4 bg-white rounded-lg border hover:border-blue-500 transition-all"><Building className="w-5 h-5 text-purple-600 mr-3" /><span>Quebec Grants</span><ExternalLink className="w-4 h-4 text-gray-400 ml-auto" /></Link>
