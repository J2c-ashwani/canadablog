...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, HelpCircle, MapPin, Briefcase, TrendingUp, Zap, Rocket } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function IRAPGovernmentGrantsBlogPage() {
  ...
  const postData = getBlogPostBySlug("irap-industrial-research-assistance-program-government-grants");
