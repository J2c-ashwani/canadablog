...
import { CheckCircle, DollarSign, Target, Factory, Wheat, Building2, Truck, Heart, Cpu, Leaf, Users, Award, HelpCircle, FileText, TrendingUp, Shield, Zap, MapPin, Rocket } from 'lucide-react'
...
export default function CanadaIndustrySpecificGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("canada-industry-specific-grants-guide");
