...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Calculator, TrendingUp, Send, Lightbulb, HelpCircle, Zap, MapPin, Rocket } from 'lucide-react'
...
export default function IRAPInnovationFundingGuidePage() {
  ...
  const postData = getBlogPostBySlug("irap-industrial-research-assistance-program-innovation");
