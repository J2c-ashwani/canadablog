...
import { CheckCircle, DollarSign, Target, AlertCircle, Building, Users, Download, Shield, TrendingUp, HelpCircle, BookOpen, ExternalLink, Plane, Rocket, ArrowRight, Award, Zap, MapPin, FileText } from 'lucide-react'
...
export default function CanadaAerospaceDefenceInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("canada-aerospace-defence-innovation-grants");
