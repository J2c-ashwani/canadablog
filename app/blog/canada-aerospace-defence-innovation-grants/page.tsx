...
import { CheckCircle, DollarSign, Target, AlertCircle, Building, Users, Download, Shield, TrendingUp, HelpCircle, BookOpen, ExternalLink, Plane, Rocket } from "lucide-react"
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section id="overview" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Canadian Aerospace and Defence Industry Overview</h2>
        ...
        <section id="strategic-innovation" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Strategic Innovation Fund for Aerospace</h2>
        ...
        <section id="defence" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Defence Innovation Programs</h2>
        ...
        <section id="space" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Canadian Space Agency Programs</h2>
        ...
        <section id="regional" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">Regional Development Agency Support</h2>
        ...
        <section id="sred" className="py-16 bg-white">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">SR&amp;ED Tax Credits for Aerospace R&amp;D</h2>
        ...
        <section id="irap" className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-6">IRAP Support for Aerospace SMEs</h2>
