...
import { CheckCircle, DollarSign, Target, Mountain, Users, Zap, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Flower2, Briefcase, TrendingUp, MapPin, Rocket, FileText } from 'lucide-react'
...
export const metadata: Metadata = {
  title: "BC Women Business Grants 2026 – Funding up to $100K Available",
...
export default function BCWomenBusinessGrants() {
  ...
  const postData = getBlogPostBySlug("bc-women-business-grants");
