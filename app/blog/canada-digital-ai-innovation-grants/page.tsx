...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, Download, Brain, Code, Database, Sparkles, ExternalLink, ArrowRight, TrendingUp, Award, Shield, Zap, MapPin, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const metadata: Metadata = {
  title: "Top Canada Digital & AI Innovation Grants (2026) – Get Up to $...",
  description: "Explore top canada digital & ai innovation grants offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function CanadaDigitalAIInnovationGrantsPage() {
  ...
  const postData = getBlogPostBySlug("canada-digital-ai-innovation-grants");
