...
import { ExternalLink, Clock, DollarSign, Target, CheckCircle, AlertCircle, Users, TrendingUp, BarChart, HelpCircle, FileText, Award, Shield, Zap, MapPin, Rocket } from 'lucide-react'
...
export default function NWBCProgramsGuide() {
  ...
  const postData = getBlogPostBySlug("nwbc-programs-guide");
