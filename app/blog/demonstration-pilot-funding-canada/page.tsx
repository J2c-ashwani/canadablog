...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Download, Rocket, Factory, Settings, TrendingUp, ExternalLink, Users, Award, Shield, Zap, MapPin, FileText } from 'lucide-react'
...
export default function DemonstrationPilotFundingCanadaPage() {
  ...
  const postData = getBlogPostBySlug("demonstration-pilot-funding-canada");
