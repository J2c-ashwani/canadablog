...
import { CheckCircle, DollarSign, Target, TrendingUp, Building, Globe, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Factory, Scale, Briefcase, MapPin, Users, Zap, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const metadata: Metadata = {
  title: "Canada Business Expansion Grants 2026 – Funding up to $100K",
  description: "Explore top canada business expansion grants offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function CanadaGrowthExpansionGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("canada-growth-expansion-grants-guide");
