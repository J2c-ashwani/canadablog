...
import { CheckCircle, DollarSign, Target, Smartphone, Laptop, ShoppingCart, Server, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Monitor, Globe, MapPin, TrendingUp, Users, Zap, Rocket, FileText } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function CanadaTechnologyAdoptionGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("canada-technology-adoption-grants-guide");
