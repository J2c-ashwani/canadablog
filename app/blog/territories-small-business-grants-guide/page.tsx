...
import { CheckCircle, DollarSign, Target, Mountain, MapPin, Building, Users, Snowflake,
  Clock, AlertTriangle, FileText, HelpCircle, Briefcase, ChevronRight,
  ExternalLink, BookOpen, TrendingUp, Leaf, Globe, Award, Shield, Zap, Rocket } from 'lucide-react'
...
export default function TerritoriesSmallBusinessGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("territories-small-business-grants-guide");
