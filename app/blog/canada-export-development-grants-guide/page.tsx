...
import { CheckCircle, DollarSign, Target, Globe, Plane, Building, Users, TrendingUp, FileText, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, MapPin, Briefcase, Zap, Rocket } from 'lucide-react'
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export const metadata: Metadata = {
  title: "Canada Export Development Grants 2026 (2026 Guide)",
  description: "Explore top canada export development grants offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function CanadaExportDevelopmentGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("canada-export-development-grants-guide");
