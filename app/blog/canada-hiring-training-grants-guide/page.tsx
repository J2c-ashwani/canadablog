...
import { CheckCircle, DollarSign, Target, Users, BookOpen, GraduationCap, Briefcase, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, UserPlus, MapPin, TrendingUp, Zap, Rocket, FileText } from 'lucide-react'
...
export const metadata: Metadata = {
  title: "Canada Hiring & Training Grants 2026 (2026 Guide)",
  description: "Explore top canada hiring & training grants offering up to $100K in funding. Check your eligibility, learn the exact application steps, and secure approval today.",
...
export default function CanadaHiringTrainingGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("canada-hiring-training-grants-guide");
