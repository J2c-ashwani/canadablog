...
import { CheckCircle, DollarSign, Target, Heart, Users, Megaphone, Shield, Award, HelpCircle, ExternalLink, ArrowRight, AlertTriangle, Lightbulb, Map, Briefcase, Mountain, TrendingUp, Zap, MapPin, Rocket, FileText } from 'lucide-react'
...
export default function WomenUserLoanFundGuide() {
  ...
  const postData = getBlogPostBySlug("women-entrepreneurship-loan-fund-canada");
