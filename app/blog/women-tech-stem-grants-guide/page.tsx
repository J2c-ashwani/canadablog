...
import { ExternalLink, Clock, DollarSign, Target, CheckCircle, AlertCircle, Zap, Cpu, Rocket, HelpCircle, Lightbulb, Users, Globe, Code, Microscope, Laptop, Award, ArrowRight, FileText, TrendingUp, Shield, MapPin } from 'lucide-react'
...
export default function WomenTechSTEMGrantsGuide() {
  ...
  const postData = getBlogPostBySlug("women-tech-stem-grants-guide");
    ...
    <><Header />
      ...
      <div className="container mx-auto px-4 py-4">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-purple-700 rounded-lg p-8 text-white text-center">
                <h3 className="text-2xl font-bold mb-4">Get Your FREE Women's Tech Grant Eligibility Audit</h3>
                ...
                <Button size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-semibold" asChild>
                  <Link href="/contact?service=women-tech-stem-consultation">
                    Book FREE Tech Grant Eligibility Audit
                  </Link>
                </Button>
        ...
        <section className="py-16 bg-gray-50 border-t border-gray-200">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-8">More Resources for Women in Tech</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-left">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Federal strategy investing $7B+ to support women entrepreneurs across all sectors.
                    </p>
                    <Button variant="outline" className="w-full text-blue-600 border-blue-200 hover:bg-blue-50" asChild>
                      <Link href="/blog/women-entrepreneurship-strategy-canada-government-grants">Read Guide</Link>
                    </Button>
                  </CardContent>
                </Card>
                <Card className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-left">
                    <h4 className="font-bold text-lg mb-2 flex items-center">
                      <FileText className="w-5 h-5 text-blue-600 mr-2" />
                      Tech Adoption Grants
                    </h4>
                    <p className="text-sm text-gray-600 mb-4">
                      Programs like CDAP offering up to $15K for digital transformation and technology adoption.
                    </p>
                    <Button variant="outline" className="w-full text-blue-600 border-blue-200 hover:bg-blue-50" asChild>
