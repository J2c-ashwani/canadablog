...
import { CheckCircle, Clock, DollarSign, Target, AlertCircle, Building, Users, FileText, Download, Shield, Award, Calculator, TrendingUp, Send, Lightbulb, Heart, Sparkles, Zap, Rocket, Globe, TrendingUp as Growth, ExternalLink, MapPin } from 'lucide-react'
...
export default function EDCWomenInTradeGuidePage() {
  ...
  const postData = getBlogPostBySlug("edc-women-trade-export-financing");
