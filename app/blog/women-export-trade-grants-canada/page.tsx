...
export const metadata: Metadata = {
  ...
  keywords: "women export grants Canada 2026, CanExport funding women, international trade support, export market development grants, Trade Commissioner Service women entrepreneurs, EDC export financing, global expansion funding women businesses Toronto Vancouver Montreal Calgary, how to apply for EDC grants 2026, EDC eligibility requirements, EDC vs CanExport comparison, how to apply for women export trade grants canada, women export trade grants canada eligibility 2026, step by step women export trade grants canada application guide, best women export trade grants canada for small business Canada, best grants for women entrepreneurs Canada 2026, women owned business funding eligibility, am I eligible for women export trade grants canada, women export trade grants canada deadline 2026",
  openGraph: {
...
export default function WomenExportTradeGrantsCanadaPage() {
  ...
  const postData = getBlogPostBySlug("women-export-trade-grants-canada");
